...
echo " ** Add hosts..."
echo "192.168.99.100 docker0.dob.lab docker0" | tee -a /etc/hosts
echo "192.168.99.101 docker1.dob.lab docker1" | tee -a /etc/hosts
echo "192.168.99.102 docker2.dob.lab docker2" | tee -a /etc/hosts
echo "192.168.99.103 docker3.dob.lab docker3" | tee -a /etc/hosts
