...
echo " ** Add hosts..."
echo "192.168.99.130 docker40" | tee -a /etc/hosts
echo "192.168.99.131 docker41" | tee -a /etc/hosts
echo "192.168.99.132 docker42" | tee -a /etc/hosts
echo "192.168.99.133 docker43" | tee -a /etc/hosts
...
# NOTE: is there an " ** Firewall" equivalent for OpenSUSE (preinstalled?)
